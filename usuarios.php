<?php
    $error='';
    if(isset($_GET['mensaje'])&& ($_GET['mensaje']=='cambio_exitoso')){
        $error = 'cuenta editada exitosamente';
     }

    if(isset($_GET['mensaje'])&& ($_GET['mensaje']=='cuenta_eliminada')){
       $error = 'cuenta eliminada exitosamente';
    }
...
<head>
    ...
    <script>
        ...
        function borrar(){
            if(!confirm("¿De verdad desea borrar este perfil? una vez borrado no se podran recuperar sus datos")){
                return false;
            }
        }
...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-9 card rounded shadow-sm mt-5">
                ...
                <h4 class="mt-4 text-center text-success"><?php echo $error ?></h4>
                ...
                <div class="mt-5 align-items-center">
                    <h4 class="text-center">Informacion de Usuarios</h4>
                </div>

                <table class="mt-1" style="border:1px solid #000"> 
                <tr style="border:1px solid #000">
                    <th class="text-center col-auto">Nombre</th>
                    <th class="text-center col-auto">Apellido</th>
                    <th class="text-center col-auto">Email</th>
...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-9 card rounded shadow-sm mt-5">
                ...
                <table class="mt-5" style="border:1px solid #000"> 
